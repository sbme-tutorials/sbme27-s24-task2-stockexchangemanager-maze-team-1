...
public class controller implements Initializable {
    ...
    public static void createUserCSV(String username) {
        ...
        String directoryPath = "src\\1_deliverable\\UserStocks/";
        String transactionPath = "src\\1_deliverable\\UserTransaction/";
    ...
    public void onlogin(ActionEvent event) throws IOException {
        ...
        if (login_username.getText().equals("z") && login_password.getText().equals("123")) {
            root = FXMLLoader.load(getClass().getResource("1_deliverable\\AdminScene.fxml"));
            ...
            if (userFound) {
                root = FXMLLoader.load(getClass().getResource("1_deliverable\\HomeScreen.fxml"));
                stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
                Scene scene = new Scene(root);
                stage.setScene(scene);
                stage.show();
