...
public class ApprovalSystemController implements Initializable {
    ...
    private ObservableList<Deposit> depositRequests() {
        ...
        try (BufferedReader br1 = new BufferedReader(new FileReader("src\\1_deliverable\\AprovalSystem.csv"))) {
            String line1;
    ...
    private void updateBalance(String username, double amountDeposit, double amountWithdraw) {
        try {
            List<String> lines = Files.readAllLines(Paths.get("src\\1_deliverable\\AprovalSystem.csv"));
            ...
            Files.write(Paths.get("src\\1_deliverable\\AprovalSystem.csv"), lines);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private void removeFromApprovalSystem(Deposit deposit) {
        try {
            ...
            Files.write(Paths.get("src\\1_deliverable\\AprovalSystem.csv"), filteredLines);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
